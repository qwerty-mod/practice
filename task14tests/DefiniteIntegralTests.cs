...
public class DefiniteIntegralTests
{
    ...
    public void InvalidArguments()
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() => DefiniteIntegral.Solve(0,  1, f, -1e-4, 2));
        Assert.Throws<ArgumentOutOfRangeException>(() => DefiniteIntegral.Solve(0,  1, f, 1e-4,  0));
    }
}
